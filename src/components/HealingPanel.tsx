...
import { GitPullRequest, Play, RotateCcw, Check, Loader2, X, Eye } from 'lucide-react';
...
export function HealingPanel({ actions, onApply, onRollback }: HealingPanelProps) {
  ...
  const [prDetail, setPrDetail] = useState<HealingAction | null>(null);
